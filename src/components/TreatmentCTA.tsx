...
export default function TreatmentCTA({
  ...
  const bulletPoints = [
    ...
    'Σε βολική τοποθεσία με εύκολη πρόσβαση στο κέντρο της Αθήνας και έξω από το μέτρο Αμπελόκηπων, το ευρύχωρο και άρτια εξοπλισμένο ιατρείο δερματολογίας μας είναι μια εύκολη επιλογή για όλες τις ανάγκες της επιδερμίδας σας. Καταλαβαίνουμε ότι έχετε ένα φορτωμένο πρόγραμμα όπως και εμείς, γι\' αυτό θέτουμε ως προτεραιότητα να σας δούμε την προγραμματισμένη ώρα του ραντεβού σας.',
  ];
